...
async def run(model: str, user_input: str):
    ...
    response = await client.chat(
        ...
        tools=[
                ...
                "function": {
                    ...
                    "parameters": {
                        ...
                        "properties": {
                            "city": {
                                "type": "string",
                                "description": "The city for which the temperature is required",
                            },
                        },
                        "required": ["city"],
                    },
            ...
            },
            {
                ...
                "function": {
                    "name": "get_news",
                    "description": "Retrieve the latest news headlines for a specified city.",
                    "parameters": {
                        "type": "object",
                        "properties": {
                            "city": {
                                "type": "string",
                                "description": "The city for which the latest news is requested.",
                            }
                        },
                        "required": ["city"]
                    }
            ...
            },
            {
                ...
                "function": {
                    "name": "get_itinerary",
                    "description": "yFetch the most popular tourist itinerary for a given city.",
                    "parameters": {
                        "type": "object",
                        "properties": {
                            "city": {
                                "type": "string",
                                "description": "The name of the city for which to fetch the tourist itinerary.",
                            },
                        },
                        "required": ["city"],
                    },
    ...
    if response["message"].get("tool_calls"):
        ...
        for tool in response["message"]["tool_calls"]:
            ...
            elif function_to_call == get_tourist_places:
                function_response = function_to_call(
                    tool["function"]["arguments"]["city"],
                )
                print(f"function response: {function_response}")

            elif function_to_call == get_news:
                function_response = function_to_call(
                    tool["function"]["arguments"]["city"],
                )
                print(f"function response: {function_response}")
...
while True:
    ...
    asyncio.run(run("llama3.2:1b", user_input))